...
import { getCustomerHoldings, clearCustomerHoldings } from '../../../redux/ducks/customer/details/holdings';
import List from '../../../components-WX/customer/details/holdings/List';
...
class reportCustomer extends Component {
  ...
  loadData = (loadMore) => {
    ...
    if (!loadMore) {
      this.props.clearCustomerHoldings();
    }
    return new Promise((resolve, reject) => {
      this.props.getCustomerHoldings(this.params);
      resolve();
    });
  };
...
const mapStateToProps = (state) => {
  ...
  const { data, totalCount, isLoading } = holdings;
