...
import List from '../../../components-WX/report/channel/List';
  ...
  render() {
    ...
    return (
      <WithTopTitle
        title="渠道报表"
      > 
        <div className="reportChannel_OutWrap">
          ...
          <DrawerFilter 
            ...
            channelData={allChannel}
            productData={allProduct}
            hasTime
            rangeTimeTitle="选择时间段"
            noSplitLine
          />
          <div className="reportChannel_Wrap">
            <div className="reportChannel_list">
              <List
