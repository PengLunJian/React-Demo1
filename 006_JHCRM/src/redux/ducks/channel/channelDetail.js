...
export const saveChannelDetail = (data) => (dispatch, getState) => {
  return dispatch(_saveChannelDetail(data));
};

//  reducers
export default function getChannelDetail(state = {
  isLoading: false,
  data: [],
}, action) {
  switch (action.type) {
