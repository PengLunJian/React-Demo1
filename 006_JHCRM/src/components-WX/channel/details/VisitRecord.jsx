...
import VisitRecordItems from './../../customer/details/VisitRecordItems';
...
import './../../customer/details/VisitRecord.less';
...
class VisitRecord extends Component {
  ...
  openAddVisitRecord = () => {
    ...
    history.push({
      pathname: CHANNEL_DETAIL + '/' + id + ADD_VISIT_RECORD,
      search: '?from=1&contactId=1'
    });
  };
