...
class Login extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      verifyCode: isWX ? '' : 'xxfx',               //  input框输入的验证码
      orgId: '',
      orgData: null,
      modalVisible: false,
      errorMsg: ''
  ...
  preLogin = () => {
    ...
    this.props.verifyCode({
          ...
          client_key: isWX ? this.VerifyCode.uuid : '5c4d8a06-baec-4b6b-8258-2717bcb17eb0',
  ...
  handleLogin = () => {
    ...
    const uuid = isWX ? this.VerifyCode.uuid : '5c4d8a06-baec-4b6b-8258-2717bcb17eb0';
  ...
  render() {
    ...
    const { username, password, verifyCode, orgId, orgData, errorMsg, modalVisible } = this.state;
    return (
      <div className="loginWrap">
        <div className="common__Login">
          <div className="midWrap">
            <div className="txtWrap">
              <div className="name">嘉合基金CRM管理平台</div>
              <div className="tips">有嘉合<span className="dot">·</span>万事兴</div>
            </div>
            <LoginPanel
        ...
        <div className="copyright">
          <div className="rights">©2018 嘉合基金管理有限公司 版权所有</div>
        </div>
      </div>
    )
  }
